  ...
  public checkAccessToken(role: ERole) {
    return async function (req: Request, res: Response, next: NextFunction) {
      try {
        ...
        const jwtPayload = tokenService.checkAuthToken(accessToken, ETokenType.ACCESS, role);
  ...
  public checkRefreshToken(role: ERole) {
    return async function (req: Request, res: Response, next: NextFunction) {
      try {
        ...
        const jwtPayload = tokenService.checkAuthToken(refreshToken, ETokenType.REFRESH, role);
